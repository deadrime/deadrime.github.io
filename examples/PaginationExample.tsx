...
//   <span className="inline-flex px-2 py-[2px] bg-secondary text-body2 text-text rounded-lg">
//     Me
//   </span>
// );

// export const PaginationExample = () => {
//   const { data, extra, hasNextPage, isFetchingNextPage, loadMore } =
//     usePaginatedData({
...
//           Current user: {extra.currentUserContact.firstName}{' '}
//           {extra.currentUserContact.lastName}
//         </span>
//       )}
//       {data.map((contact) => {
...
//               {firstName} {lastName} {isMe && <CurrentUserBadge />}
//             </span>
