    ...
    <section className={classNames("flex flex-col relative", styles.wrapper)}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 text-body2 text-text/80 pt-8">
        <div className={classNames(styles.blogContent, 'md:col-span-6')} id="content">
          ...
          <p>
            Больше всего интересует позиция <strong>frontend разработчика</strong> (или fullstack с беком на node.js).
            Круто, если вы используете современный стек технологий и у вас в команде есть талантливые люди, у которых я мог бы учиться и расти.
          </p>
