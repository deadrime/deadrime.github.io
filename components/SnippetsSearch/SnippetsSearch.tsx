...
export const SnippetsSearch: React.FC<SnippetsSearchProps> = ({ snippets }) => {
  ...
  const filteredList = useFuzzySearchList({
    ...
    mapResultItem: ({
      item,
      matches: [titleHighlightRanges, descriptionHighlightRanges],
  ...
  return (
    <div>
      <TextInput
        ...
        className="mb-6"
      />
      {noResults && <div>Ничего не найдено</div>}
