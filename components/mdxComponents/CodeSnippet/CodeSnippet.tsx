...
export const CodeHighlight: React.FC<CodeHighlightProps> = ({
  ...
  return (
    <Highlight
      ...
      language={language}
      theme={theme === 'dark' ? codeDarkTheme : themes.oneLight}
    >
      {({ style, tokens, getLineProps, getTokenProps }) => (
        <div
          ...
          className={classNames(
            ...
            className,
            'flex overflow-x-auto py-3 font-fira',
          )}
        >
...
type CodeSnippetProps = CodeHighlightProps &
...
export const CodeSnippet: React.FC<CodeSnippetProps> = ({
  ...
  <div
    className={classNames(
      className,
      styles.codeSnippet,
      'text-body2 border border-gray-100 dark:border-gray-700 rounded-sm overflow-hidden',
    )}
    data-lang={language}
  ...
  >
    ...
    >
      {iconByLanguage[language]
        ? createElement(iconByLanguage[language], { className: 'w-5' })
        : null}
      {caption}
